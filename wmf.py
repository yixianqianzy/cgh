...
B = traindata_r['R_train']

S = log_surplus_confidence_matrix(B.transpose(), alpha=2.0, epsilon=1e-6)

U, V = factorize(S, num_factors=200, lambda_reg=1e-5, num_iterations=2, init_std=0.01, verbose=True, dtype='float32', recompute_factors=recompute_factors_bias)
sio.savemat('./data/u_factor.mat', {'u_factor': U})
sio.savemat('./data/v_factor.mat', {'v_factor': U})
